...
% It can be seen that the transfer function for the displacement
% andvelocity of the motor are approximately equal, less so on the
% velocity side even after filtering the experimental data, but especially
% so on the displacement over time. The angular velocities and correponding
% angular displacements recorded by the robot also closely match the
% experimental data, but the experimental data seems to have more noise and
% even a little drift.