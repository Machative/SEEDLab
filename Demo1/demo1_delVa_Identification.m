...
robotResp = readmatrix('ID_angVelExperiment.xlsx');
...
% It can be seen that the transfer function for the angular displacement
% and angular velocity of the motor are approximately equal, less so on the
% velocity side even after filtering the experimental data, but especially
% so on the angle over time. The forward velocities and correponding
% forward displacements recorded by the robot also closely match the
% experimental data. 